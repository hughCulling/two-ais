...
const el = {
    ...
    "pricing": {
        ...
        "tts": {
            "geminiFlash": {
                "textTokens": "0,50 $ ανά 1 εκατομμύριο διακριτικά κειμένου",
                "audioTokens": "10,00 $ ανά 1 εκατομμύριο ηχητικά tokens"
            },
            "geminiPro": {
                "textTokens": "1,00 $ ανά 1 εκατομμύριο διακριτικά κειμένου",
                "audioTokens": "20,00 $ ανά 1 εκατομμύριο ηχητικά tokens"
            },
            "openAIMini": {
                "textTokens": "0,60 $ ανά 1 εκατομμύριο διακριτικά κειμένου",
                "audioTokens": "12,00 $ ανά 1 εκατομμύριο ηχητικά tokens"
            },
            "openAITTS1": {
                "standard": "15,00 $ ανά 1 εκατομμύριο μάρκες"
            },
            "openAITTS1HD": {
                "standard": "30,00 $ ανά 1 εκατομμύριο μάρκες"
            },
            "plusSign": " + ",
            "googleCloud": {
                "standard": "4,00 $ ανά 1 εκατομμύριο χαρακτήρες",
                "neural": "16,00 $ ανά 1 εκατομμύριο χαρακτήρες",
                "studio": "160,00 $ ανά 1 εκατομμύριο χαρακτήρες",
                "chirpHD": "Δεν ήταν δυνατή η επαλήθευση",
                "chirp3HD": "30,00 $ ανά 1 εκατομμύριο χαρακτήρες"
            }
        }
    }
};
