...
export const pt = {
    ...
    settings: {
        ...
        apiKeys: {
            ...
            getKeyInstructions: 'Obtenha sua chave API',
            // --- New keys for ApiKeyManager.tsx ---
            noNewKeys: "Nenhuma nova chave API inserida para salvar.",
            unexpectedResponse: "Recebida uma resposta inesperada do servidor.",
            failedToSaveKey: "Falha ao salvar a chave {serviceName}.",
            someKeysNotSaved: "Algumas chaves API não puderam ser salvas. Verifique os detalhes abaixo.",
            keyStatus: "status da chave...",
            apiKeySecurelySaved: "Chave API salva com segurança",
            confirmRemoveTitle: "Confirmar remoção",
            confirmRemoveDescription: "Tem certeza de que deseja remover a chave API para {serviceName}? Esta ação não pode ser desfeita.",
