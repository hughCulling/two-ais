...
const fa = {
    ...
    "pricing": {
        ...
        "tts": {
            "geminiFlash": {
                "textTokens": "۰.۵۰ دلار به ازای هر ۱ میلیون توکن متنی",
                "audioTokens": "۱۰ دلار به ازای هر ۱ میلیون توکن صوتی"
            },
            "geminiPro": {
                "textTokens": "۱.۰۰ دلار به ازای هر ۱ میلیون توکن پیامکی",
                "audioTokens": "20.00 دلار به ازای هر 1 میلیون توکن صوتی"
            },
            "openAIMini": {
                "textTokens": "۰.۶۰ دلار به ازای هر ۱ میلیون توکن متنی",
                "audioTokens": "۱۲ دلار به ازای هر ۱ میلیون توکن صوتی"
            },
            "openAITTS1": {
                "standard": "۱۵ دلار به ازای هر ۱ میلیون توکن"
            },
            "openAITTS1HD": {
                "standard": "30.00 دلار به ازای هر 1 میلیون توکن"
            },
            "plusSign": " + ",
            "googleCloud": {
                "standard": "۴.۰۰ دلار به ازای هر ۱ میلیون کاراکتر",
                "neural": "۱۶ دلار به ازای هر ۱ میلیون کاراکتر",
                "studio": "۱۶۰ دلار به ازای هر ۱ میلیون کاراکتر",
                "chirpHD": "تأیید نشد",
                "chirp3HD": "30.00 دلار به ازای هر 1 میلیون کاراکتر"
            }
        }
    }
};
