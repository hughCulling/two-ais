...
export const hu = {
    ...
    settings: {
        ...
        language: {
            ...
            noNewKeys: "Nincsenek mentésre megadott új API-kulcsok.",
            unexpectedResponse: "Váratlan válasz érkezett a szerverről.",
            failedToSaveKey: "A(z) {serviceName} kulcs mentése sikertelen.",
            someKeysNotSaved: "Néhány API-kulcsot nem sikerült menteni. Kérjük, ellenőrizze az alábbi részleteket.",
            keyStatus: "kulcs állapota...",
            apiKeySecurelySaved: "API-kulcs biztonságosan mentve",
            confirmRemoveTitle: "Eltávolítás megerősítése",
            confirmRemoveDescription: "Biztosan el szeretné távolítani a(z) {serviceName} API-kulcsát? Ez a művelet nem vonható vissza.",
            failedToRemoveKey: "A(z) {serviceName} kulcs eltávolítása sikertelen.",
            successfullyRemovedKey: "A(z) {serviceName} kulcs sikeresen eltávolítva.",
            keyNotSet: "Kulcs állapota: Nincs beállítva",
            keySet: "Kulcs állapota: Beállítva",
            saveButton: "API-kulcs(ok) mentése"
        },
        apiKeys: {
            title: 'API kulcsok',
