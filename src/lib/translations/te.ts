...
const te = {
    ...
    "pricing": {
        ...
        "tts": {
            "geminiFlash": {
                "textTokens": "1 మిలియన్ టెక్స్ట్ టోకెన్‌లకు $0.50",
                "audioTokens": "1 మిలియన్ ఆడియో టోకెన్‌లకు $10.00"
            },
            "geminiPro": {
                "textTokens": "1 మిలియన్ టెక్స్ట్ టోకెన్‌లకు $1.00",
                "audioTokens": "1 మిలియన్ ఆడియో టోకెన్‌లకు $20.00"
            },
            "openAIMini": {
                "textTokens": "1 మిలియన్ టెక్స్ట్ టోకెన్‌లకు $0.60",
                "audioTokens": "1 మిలియన్ ఆడియో టోకెన్‌లకు $12.00"
            },
            "openAITTS1": {
                "standard": "1 మిలియన్ టోకెన్‌లకు $15.00"
            },
            "openAITTS1HD": {
                "standard": "1 మిలియన్ టోకెన్‌లకు $30.00"
            },
            "plusSign": " + ",
            "googleCloud": {
                "standard": "1 మిలియన్ అక్షరాలకు $4.00",
                "neural": "1 మిలియన్ అక్షరాలకు $16.00",
                "studio": "1 మిలియన్ అక్షరాలకు $160.00",
                "chirpHD": "ధృవీకరించలేకపోయింది",
                "chirp3HD": "1 మిలియన్ అక్షరాలకు $30.00"
            }
        }
    }
};
