...
const hi = {
    ...
    "pricing": {
        ...
        "mistralFreeTierNote": "दर सीमाओं के साथ निःशुल्क स्तर उपलब्ध है। Mistral AI खाता। API अनुरोधों का उपयोग प्रशिक्षण के लिए किया जा सकता है Mistralके मॉडल.",
        "freeBuiltIn": "निःशुल्क (अंतर्निहित)",
