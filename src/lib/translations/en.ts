...
const en = {
    ...
    page_OllamaStep3: "1. OLLAMA_ORIGINS=https://www.two-ais.com ollama serve",
    page_OllamaStep4: "2. If you still see these instructions after completing the steps, you may need to refresh your page, if successful it will say that Ollama has been detected. Then you can sign in to Two AIs and select your Ollama model!",
