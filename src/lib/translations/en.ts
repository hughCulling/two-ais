...
const en = {
    ...
    page_ApiKeysRequiredTitle: "API Key Required (or use Ollama)",
    page_ApiKeysRequiredDescription: "To run conversations, you'll need to provide your own Mistral AI API key after signing in. Alternatively, you can use Ollama for free local AI models. Detailed instructions can be found on the {settingsLink} page after signing in.",
