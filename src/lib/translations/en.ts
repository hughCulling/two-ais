...
const en = {
    ...
    page_ApiKeysRequiredDescription: "To run conversations, you'll need to provide your own API key for the AI model you wish to use after signing in. Detailed instructions for Mistral AI can be found on the Settings / API Key page after signing in.",
