...
const en = {
    ...
    page_WelcomeSubtitle: "This website lets you listen to conversations between two Large Language Models (LLMs) using Text-to-Speech (TTS) and generate an image for each paragraph using Text-to-Image.",
    page_ApiKeysRequiredTitle: "Mistral AI API Key or Ollama Required",
    ...
    page_OllamaSetupTitle: "Ollama Setup",
    ...
    sessionSetupForm: {
        ...
        selectLLMForAgentB: 'LLM selector for Agent B',
        ...
        per: 'per',
        enableImageGen: 'Enable Text-to-Image',
        imageModel: 'Image Model',
        quality: 'Quality',
        size: 'Size',
        promptLLM: 'Prompt LLM',
        imagePromptSystemMessage: 'Image Prompt System Message',
        defaultImagePromptSystemMessage: 'Create a prompt to give to the Text-to-Image model based on this paragraph: {turn}',
