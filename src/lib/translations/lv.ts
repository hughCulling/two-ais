...
export const lv = {
    ...
    settings: {
        ...
        language: {
            ...
            unexpectedResponse: "Saņemta neparedzēta atbilde no servera.",
            ...
            confirmRemoveDescription: "Vai tiešām vēlaties noņemt {serviceName} API atslēgu? Šo darbību nevar atsaukt.",
