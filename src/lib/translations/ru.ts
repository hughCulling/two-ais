...
const ru = {
    ...
    "pricing": {
        ...
        "mistralFreeTierNote": "Доступен бесплатный тариф с ограничениями по скорости. Требуется Mistral AI счет. API запросы могут быть использованы для обучения Mistralмодели.",
        "freeBuiltIn": "Бесплатно (встроено)",
