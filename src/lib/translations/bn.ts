...
const bn = {
    ...
    "pricing": {
        ...
        "tts": {
            "geminiFlash": {
                "textTokens": "প্রতি ১০ লক্ষ টেক্সট টোকেনে $০.৫০",
                "audioTokens": "প্রতি ১ মিলিয়ন অডিও টোকেনে $১০.০০"
            },
            "geminiPro": {
                "textTokens": "প্রতি ১০ লক্ষ টেক্সট টোকেনে $১.০০",
                "audioTokens": "প্রতি ১ মিলিয়ন অডিও টোকেনে $২০.০০"
            },
            "openAIMini": {
                "textTokens": "প্রতি ১ মিলিয়ন টেক্সট টোকেনে $০.৬০",
                "audioTokens": "প্রতি ১ মিলিয়ন অডিও টোকেনে $১২.০০"
            },
            "openAITTS1": {
                "standard": "প্রতি ১ মিলিয়ন টোকেনে $১৫.০০"
            },
            "openAITTS1HD": {
                "standard": "প্রতি ১ মিলিয়ন টোকেনে $৩০.০০"
            },
            "plusSign": " + ",
            "googleCloud": {
                "standard": "প্রতি ১০ লক্ষ অক্ষরের জন্য ৪.০০ ডলার",
                "neural": "প্রতি ১০ লক্ষ অক্ষরের জন্য $১৬.০০",
                "studio": "প্রতি ১ মিলিয়ন অক্ষরের জন্য $১৬০.০০",
                "chirpHD": "যাচাই করা যায়নি",
                "chirp3HD": "প্রতি ১০ লক্ষ অক্ষরের জন্য ৩০.০০ ডলার"
            }
        }
    }
};
