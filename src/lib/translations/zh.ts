...
export const zh = {
    ...
    settings: {
        ...
        language: {
            ...
            noNewKeys: "没有新的 API 密钥需要保存。",
            unexpectedResponse: "收到来自服务器的意外响应。",
            failedToSaveKey: "未能保存 {serviceName} 密钥。",
            someKeysNotSaved: "某些 API 密钥无法保存。请检查以下详细信息。",
            keyStatus: "密钥状态...",
            apiKeySecurelySaved: "API 密钥已安全保存",
            confirmRemoveTitle: "确认删除",
            confirmRemoveDescription: "您确定要删除 {serviceName} 的 API 密钥吗？此操作无法撤销。",
            failedToRemoveKey: "未能删除 {serviceName} 密钥。",
            successfullyRemovedKey: "已成功删除 {serviceName} 密钥。",
            keyNotSet: "密钥状态：未设置",
            keySet: "密钥状态：已设置",
