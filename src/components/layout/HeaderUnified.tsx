...
export default function HeaderUnified() {
    ...
    const mobileMenuItemClasses = "block px-4 py-1.5 rounded-md text-base font-medium text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 w-full text-center";
            ...
            <header className="liquid-glass-themed bg-theme-primary/90 dark:bg-gray-800/90 shadow-sm relative z-50">
                <nav className="container mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="relative flex items-center justify-center h-16">
                        ...
                        <Link
                            href={homeLink}
                            className="text-xl font-bold text-gray-900 dark:text-theme-primary hover:opacity-80 transition-opacity"
                        ...
                        <div className="absolute right-0 flex items-center">
                            <button
                                ...
                                type="button"
                                className="liquid-glass-button inline-flex items-center justify-center p-2 text-gray-800 dark:text-white focus:outline-none focus:ring-2 focus:ring-inset focus:ring-gray-500"
