      ...
      <div className="container mx-auto px-4">
        <div className="flex justify-center items-center">
          <a
            ...
            title="GitHub/hughCulling/two-ais"
            className="relative inline-flex items-center justify-center text-foreground transition-all duration-200 hover:scale-105 hover:opacity-90 transform"
          >
            <span className="relative inline-block">
              ...
              <svg
                ...
                viewBox="0 0 24 24"
                fill="currentColor"
                className="absolute left-full ml-2 top-1/2 -translate-y-1/2 transition-transform duration-200"
                aria-hidden="true"
              >
